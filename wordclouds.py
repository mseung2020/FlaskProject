...
def get_word_frequencies(stock_code: str, num_pages: int = 10) -> tuple[str, BytesIO]:
    ...
    top_words = dict(sorted(filtered_counts.items(), key=lambda x: x[1], reverse=True)[:50])
    return top_words